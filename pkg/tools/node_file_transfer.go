...
func validateRetainedJobArtifactDownload(
	...
	protocolMatches := matchingNodeProtocol(
...
func matchingNodeProtocol(planVersion, snapshotVersion int) bool {
	return planVersion == nodes.ProtocolVersion && snapshotVersion == nodes.ProtocolVersion
}

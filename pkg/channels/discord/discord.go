...
import (
	...
	"github.com/bogdanovich/mintclaw/pkg/audio"
...
func (c *DiscordChannel) DeliverText(
	ctx context.Context,
...
func (c *DiscordChannel) sendText(ctx context.Context, msg bus.OutboundMessage) ([]string, error) {
	if !c.IsRunning() {

// Package project owns the lightweight, restart-stable identity of a coding
// project. It deliberately has no dependency on threads, providers, sessions,
// or the in-process agent runtime so process supervisors can reuse it.
package project

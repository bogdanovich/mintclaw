...
// Activity is the protocol-v2 worker lifecycle projection.
...
// Item is the closed protocol-v2 renderer-neutral presentation unit. It is
...
// SnapshotFromFrontend copies the bounded protocol-v2 projection from the

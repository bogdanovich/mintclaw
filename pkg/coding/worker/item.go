...
// Activity is the protocol-v3 worker lifecycle projection.
...
// Item is the closed protocol-v3 renderer-neutral presentation unit. It is
...
// SnapshotFromFrontend copies the bounded protocol-v3 projection from the

...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open MintClaw console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About MintClaw",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit MintClaw",
		Exiting:            "Exiting MintClaw...",
		DocUrl:             "https://github.com/bogdanovich/mintclaw/tree/main/docs",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 MintClaw 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 MintClaw",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 MintClaw",
		Exiting:            "正在退出 MintClaw...",
		DocUrl:             "https://github.com/bogdanovich/mintclaw/tree/main/docs",
	},
}

...
- [Doctor safety and operational audit](doctor.md): audit configuration, access, tools, credentials, tasks, deliveries, and restart state.
...
- [Config Schema Contract](config-versioning.md): current-version loading and coordinated schema cutovers.

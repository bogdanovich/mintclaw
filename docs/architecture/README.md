...
- [Architecture Simplification Roadmap](architecture-simplification-roadmap.md):
  current-only internal contracts, removal of backward-compatibility paths,
  browser/task/delivery ownership consolidation, AgentLoop decomposition, and
  an in-process coding frontend.

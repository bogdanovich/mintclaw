// mintclaw-echo-server is a minimal MintClaw Protocol WebSocket server for testing
// the mintclaw_client channel. It accepts connections, prints received messages
...
//
// Then configure mintclaw_client with url=ws://localhost:9090/ws&token=secret.
package main

...
| Extend the runtime | [Skills](docs/guides/skills.md) · [Tools](docs/reference/tools_configuration.md) · [MCP CLI](docs/reference/mcp-cli.md) · [Node companion](docs/guides/node-companion.md) |

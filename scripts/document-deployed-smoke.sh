...
for marker in \
	...
	MINTCLAW_PDF3_PROTECTED_STORE_OK \
	MINTCLAW_PDF3_INTERACTION_UX_OK \
	MINTCLAW_PDF3_RESTART_COMPACTION_OK \
	MINTCLAW_PDF3_MAPPING_REVIEW_OK \
	MINTCLAW_PDF3_APPROVAL_OK \
	MINTCLAW_PDF3_PDF2_COMMIT_OK \
	MINTCLAW_PDF3_SOURCE_UNCHANGED_OK \
	MINTCLAW_PDF3_SINGLE_DELIVERY_OK \
	MINTCLAW_PDF3_PRIVACY_OK \
	MINTCLAW_PDF3_CLEANUP_OK \
	MINTCLAW_PDF3_AGENT_OK \
	MINTCLAW_PDFI1_NATURAL_INTAKE_OK; do
...
echo "marker=MINTCLAW_PDF3_DEPLOYED_OK"
echo "marker=MINTCLAW_PDFI1_DEPLOYED_OK"
REMOTE
